...
export default function Footer() {
  return (
    <footer className="bg-gray-950 text-white py-10 px-6 md:px-24">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            TimeWise helps you track time effortlessly, manage projects, and
            generate insightful reports to boost productivity.
          </p>
        </div>
        ...
        <div>
          ...
          <a className="text-sm text-gray-400" href="tel:9265646507">
            Phone: +91 9265646507
          </a>
        </div>
      </div>
